            ...
            with inp.open("r", encoding="utf-8") as f:
                for line in f:
                    ...
                    if prov == "Animals-10":
                        ...
                        if attrs:
                            x["physical_attributes"]["size_class"] = {"value": attrs["size_class"], "confidence": 1.0}
                            x["physical_attributes"]["weight_class"] = {"value": attrs["weight_class"], "confidence": 1.0}
                            x["physical_attributes"]["brachycephalic"] = {"value": bool(attrs["brachycephalic"]), "confidence": 1.0}
                            x["physical_attributes"]["needs_carrier"] = {"value": "unknown", "confidence": 0.0}

                    # oxford enrichment
                    if prov.startswith("Oxford"):
                        breed = (x.get("breed") or "").lower()
